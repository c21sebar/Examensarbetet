...
def make_json(vehicles,filename,timeH,timeM,retrun_start):
    data = {
        "vehicles":[],
        "shipments":[]
    }
    ...
    for i,name in enumerate(names_list):
        ...
        tw = [[timeH * 3600 + timeM * 60, timeH*3600 + timeM * 60]]
...
def bfs_vroom(costMethod):
    ...
    make_json(8,'data2023tw1',7,40,"") # input for vroom
    ...
    make_json(6,'data2023tw3',9,40,"Framnäs Badet")
        
    best_cost_value_3,tw3_start_loc,tw3_duration = save_routes_and_remove("Output/output3.json",costMethod,"tw3")
    print(f"BEST COST OF ROUTE TWO: {best_cost_value_3} TW3 START: {tw3_start_loc} TW3 DURATION: {tw3_duration}")
